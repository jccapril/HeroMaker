...
class SettingViewModel: ViewModel {
    private(set) lazy var items: OrderedDictionary<SettingSection, [SettingItemViewModel]> = [
        ...
        SettingSection.app: [
            SettingItemViewModel(sectionID: 0, itemID: 0, title: "账户信息", detailText: "未绑定"),
            SettingItemViewModel(sectionID: 0, itemID: 1, title: "关于Cupid", separator: false),
        ],
        SettingSection.privacy: [
            SettingItemViewModel(sectionID: 1, itemID: 0, title: "系统权限管理"),
            ...
            SettingItemViewModel(sectionID: 1, itemID: 5, title: "隐私保护声明", separator: false),
        ],
    ]
}
